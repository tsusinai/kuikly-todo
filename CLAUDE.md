...
The Kuikly AI skills are installed under `.claude/skills/` (e.g. `kuikly-compose-ui-framework`). Invoke the relevant one when working on Kuikly UI components, modules, layouts, or routing.
